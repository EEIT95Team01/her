...
const apis = {
	"#Tag_insert_button": {
		apiPath: '/admin/api/tag',
		method: 'POST',
		getData: {
			name: function() {return $('#Tag_manage_name').val()},
